...
var schemeChar = {
  ...
  'darkelf-rogue': { filename: 'char/darkelf_02_rogue', pos: [ 0, 400 ] },
  'darkelf-mage': { filename: 'char/darkelf_03_mage', pos: [ -20, 400 ] },
  'dwarf-warrior': { filename: 'char/dwarf_01_warrior', pos: [ 50, 350 ] },
  'dwarf-rogue': { filename: 'char/dwarf_02_rogue', pos: [ 0, 400 ] },
  'dwarf-mage': { filename: 'char/dwarf_03_mage', pos: [ 0, 400 ] },
  'elf-warrior': { filename: 'char/elf_01_warrior', pos: [ -120, 400 ] },
  'elf-rogue': { filename: 'char/elf_02_rogue', pos: [ -20, 400 ] },
  'elf-mage': { filename: 'char/elf_03_mage', pos: [ 0, 400 ] },
  'human-warrior': { filename: 'char/human_01_warrior', pos: [ -140, 400 ] },
  'human-rogue': { filename: 'char/human_02_rogue', pos: [ -20, 400 ] },
  'human-mage': { filename: 'char/human_03_mage', pos: [ -20, 400 ] },
};
var schemeStat = {
