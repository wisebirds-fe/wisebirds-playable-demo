 ...
 */
var schemeChar = {
  'darkelf-warrior': { filename: 'char/darkelf_01_warrior', pos: [ 120, 550 ] },
  'darkelf-rogue': { filename: 'char/darkelf_02_rogue', pos: [ 180, 500 ] },
  'darkelf-mage': { filename: 'char/darkelf_03_mage', pos: [ 250, 400 ] },
  'dwarf-warrior': { filename: 'char/dwarf_01_warrior', pos: [ 300, 550 ] },
  'dwarf-rogue': { filename: 'char/dwarf_02_rogue', pos: [ 130, 530 ] },
  'dwarf-mage': { filename: 'char/dwarf_03_mage', pos: [ 130, 530 ] },
  'elf-warrior': { filename: 'char/elf_01_warrior', pos: [ -30, 510 ] },
  'elf-rogue': { filename: 'char/elf_02_rogue', pos: [ 150, 500 ] },
  'elf-mage': { filename: 'char/elf_03_mage', pos: [ 250, 500 ] },
  'human-warrior': { filename: 'char/human_01_warrior', pos: [ -100, 500 ] },
  'human-rogue': { filename: 'char/human_02_rogue', pos: [ 300, 520 ] },
  'human-mage': { filename: 'char/human_03_mage', pos: [ 250, 450 ] },
};
var schemeStat = {
...
function preload() {
  ...
  for (scmChar in schemeChar) {
    if (schemeChar.hasOwnProperty(scmChar)) {
      ...
      game.load.image(scmChar, 'assets/images/' + scm.filename + '.png');
    }
  }
